...
cpdefine("inline:com-chilipeppr-elem-dragdrop", ["chilipeppr_ready"], function () {
    ...
    return {
        ...
        init: function () {
            ...
            $('.com-chilipeppr-elem-dragdrop-loadeagleadafruitruler').click("//i2dcui.appspot.com/slingshot?url=https://raw.githubusercontent.com/chilipeppr/elem-dragdrop/master/ESP8266Ring.brd", this.loadUrlDoNotCreateRecentFileEntry.bind(this));
